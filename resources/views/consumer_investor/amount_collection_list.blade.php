...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card card-info card-outline">
                    ...
                    <div class="card-body p-3">
                        {{-- <form action="{{ route('return-invest-list') }}" method="get">
                            <div class="row pb-3">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <select name="invest_id" class="form-control">
                                        ...
                                        @foreach ($invests as $invest)
                                            <option value="{{ $invest->id }}">{{ $invest->client_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-lg-2">
                        ...
                        {{-- <div class="row">
                            <div class="col-12 text-right">
                                <a href="{{ url('return-invest-print?fund_id=' . request()->get('fund_id') . '&invest_id=' . request()->get('invest_id') . '&start_date=' . request()->get('start_date') . '&bank_id=' . request()->get('bank_id') . '&end_date=' . request()->get('end_date')) }}"
                                ...
                                @foreach ($collections as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('printCollectInvestVoucher', $item->id) }}" target="_blank"><i
    ...
    @foreach ($collections as $v_data)
        @php
            $company_info = App\Models\Company::where('id', $v_data->company_id)->first();
        @endphp
                    ...
                    <div class="modal-body">
                        <div class="container-voucher">
                            ...
                            <div class="voucher-info">
                                ...
                                <div><input type="checkbox" {{ $v_data->payment_type_id == 1 ? 'checked' : '' }}><strong>
                                        Cash</strong>
                                </div>
                                <div><input type="checkbox" {{ $v_data->payment_type_id == 3 ? 'checked' : '' }}><strong>
                                        Bank</strong>
                                </div>
                                <div><strong>Date: {{ date('d/m/Y', strtotime($v_data->date)) }}</strong></div>
                            </div>

                            <!-- Head of Accounts and Received From Section -->
                            <div class="details-section">
                                <div class="dotted-container"><strong>Head of Accounts:</strong>
                                    <span class="dotted-line-voucher">Consumer Investment Collection</span>
                                </div>
                                <div class="dotted-container"><strong>Received From:</strong><span
                                        class="dotted-line-voucher">{{ $v_data->consumer->name ?? '' }}</span></div>
                            </div>
                            ...
                            <table class="details-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td>
                                            <strong>{{ $v_data->note ?? '' }}</strong>
                                        </td>
                                        <td>{{ number_format($v_data->collect_amount, 2) }}</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        @php
                                            ...
                                            $amount = getBangladeshCurrency($v_data->collect_amount);
                                        @endphp
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <div>
                            <button type="button" class="btn btn-light">
                                <a href="{{ route('investor_money_receipt', $v_data->id) }}" target="_blank"><i
                        ...
                        <div class="money-receipt">
                            ...
                            <div class="receipt-details" style="display: flex; justify-content: space-between;">
                                ...
                                <div class="payment-type-section">
                                    <label>Cash <input type="checkbox"
                                            {{ $v_data->payment_type_id == 1 ? 'checked' : '' }} /></label>
                                    ...
                                    <p>Date: {{ $v_data->date ?? '' }}</p>
                                </div>


                                <div style="text-align: left; font-size: 14px; margin-bottom: 10px;">
                                    <p style="margin-bottom: 25px;">Date:
                                        {{ date('d.m.Y', strtotime($v_data->date)) }}</p>
                                    ...
                                    <p>Total Amount:
                                        <span style="border: 1px solid black; padding: 5px 10px; display: inline-block;">
                                            <strong>{{ number_format($v_data->collect_amount, 2) }} Tk</strong>
                                        </span>
                                    </p>
                            ...
                            <div class="details-section-receipt">
                                <p>Received with thanks from
                                    <span class="dotted-line"><b>{{ $v_data->consumer->name ?? '' }}</b></span>
                                </p>

                                <p>On account of
                                    <span
                                        class="dotted-line"><b>Consumer Investment Collection</b></span>
                                </p>
