 ...
 <body>      
    <div class="container mt-5">
        ...
        <div class="voucher-info">
            ...
            <div><input type="checkbox" {{ $model->payment_type_id == 1 ? 'checked' : '' }}><strong>
                    Cash</strong>
            </div>
            <div><input type="checkbox" {{ $model->payment_type_id == 3 ? 'checked' : '' }}><strong>
                    Bank</strong>
            </div>
            <div><strong>Date: {{ date('d/m/Y', strtotime($model->date)) }}</strong></div>
        </div>
        ...
        <div class="details-section">
            ...
            <div class="dotted-container"><strong>Received From:</strong><span
                    class="dotted-line-voucher">{{ $model->consumer->name ?? '' }}</span></div>
        </div>
