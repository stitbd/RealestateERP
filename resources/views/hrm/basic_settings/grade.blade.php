                  ...
                  <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($item->status == '1')
                                    <a href="{{ route('change-grade-status',['0',$item->id]) }}" class="text-success text-bold">Active</a>
                                @else
                                    <a href="{{ route('change-grade-status',['1',$item->id]) }}" class="text-danger text-bold">Inactive</a>
                                @endif
                            </td>
                            <td>
...
<div class="modal fade" id="modal-add">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form action="{{ route('save-grade') }}" method="post" enctype="multipart/form-data">
            @csrf
...
<div class="modal fade" id="modal-edit">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form action="{{ route('update-grade') }}" method="post" enctype="multipart/form-data">
            @csrf
...
<script>
    function load_edit_body(grade_id,name){
