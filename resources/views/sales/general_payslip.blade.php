    ...
    <div class="container mt-5">
        ...
        <div class="header-section">
            ...
            <div class="voucher-show-info">
                ...
                <div
                    ...
                    <h3 style="margin: 0; font-size: 16px;"><strong>{{ $model->landSale->invoice_no }}</strong>
                    </h3>
                </div>
                <div class="mt-1"
        ...
        <div class="voucher-info">
            <div><strong><i class="fas fa-globe" style="margin-right: 5px;"></i>www.unitylandmark.com</strong></div>
                ...
                <div><input type="checkbox" {{ $model->PaymentType->name == 'Bank' ? 'checked' : '' }}><strong>
                        Bank</strong>
                </div>
            <div><strong>Date: {{ date('d/m/Y', strtotime($model->landSale->initial_payment_made_date)) }}</strong></div>
        </div>
        ...
        <div class="details-section">
            <div><strong>Head of Accounts:</strong>
                ...
                {{-- {{ $model->landSale->type == 'Flat' ? 'Flat Sale' : 'Plot Sale' }} --}}
                {{
                    $model->landSale->type == 'Flat' ? 'Flat Sale' :
                    ($model->landSale->type == 'Plot' ? 'Plot Sale' :
                    ($model->landSale->type == 'Land' ? 'Land Sale' : ''))
                }}
            ...
            <div><strong>Received From:</strong> {{ $model->landSale->customer->customer_name ?? '' }}</div>
        </div>
