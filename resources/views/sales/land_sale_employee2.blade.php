                ...
                <div class="card card-info card-outline">
                    <div class="card-header">
                        <h3 class="card-title col-sm-10">
                            Director/ Co-ordinator/ Shareholder List
                        </h3>
                                ...
                                @foreach ($sale_employees as $item)
                                    <tr>
                                        ...
                                        <td class="text-center"
                                            ...
                                            {{ $item->director->employee_name ?? 0 }}
                                        </td>
                                        <td class="text-center"
                                            style="max-width: 200px; overflow: hidden; text-overflow: ellipsis;">
                                            {{ $item->coordinator->employee_name ?? 0 }}
                                        </td>
                                        <td class="text-center">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h4 class="modal-title">Add Director/ Co-ordinator/ Shareholder</h4>
                ...
                <form action="{{ route('land_sale_employee_store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    <label class="form-label">Date Of Birth<i class="text-danger">*</i></label>
        ...
        <div class="modal fade update update-modal-{{ $item->id }}" id="exampleModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form action="{{ route('update_land_sale_employee', $item->id) }}" method="POST"
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <label for="user_type_id">User Type<i class="text-danger">*</i></label>
                                    <select name="user_type_id" id="user_type_id_edit_{{ $item->id }}"
                                        class="form-control" disabled>
                                        <option value="" selected>Select Type</option>
                                        @foreach ($user_type as $type)
                                            <option value="{{ $type->id }}"
                                                @if ($type->id == $item->user_type_id) selected @endif>{{ $type->type }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                @if ($item->director_id != 0)
                                    <div class="col-lg-12">
                                        <label for="director_id">Director<i class="text-danger">*</i></label>
                                        <select name="director_id" id="director_id_edit_{{ $item->id }}"
                                            class="form-control" disabled>
                                            <option value="0">Select One</option>
                                            @foreach ($land_sale_director as $employee)
                                                <option value="{{ $employee->id }}"
                                                    @if ($employee->id == $item->director_id) selected @endif>
                                ...
                                @if ($item->coordinator_id != 0)
                                    <div class="col-lg-12">
                                        <label for="coordinator_id">Co-ordinator</label>
                                        <select name="coordinator_id" id="coordinator_id_edit_{{ $item->id }}"
                                            class="form-control" disabled>
                                            <option value="0">Select One</option>
                                            @foreach ($land_sale_coordinator as $employee)
                                                <option value="{{ $employee->id }}"
                                                    @if ($employee->id == $item->coordinator_id) selected @endif>
                                                    {{ $employee->employee_name }},
                                                    ({{ $employee->userType->type }})
                                                </option>
                                            @endforeach
...
@push('script_js')
    ...
    <script>
        $(document).ready(function() {
            // Ensure containers are hidden on load
