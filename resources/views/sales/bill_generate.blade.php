...
<body>
    ...
    <div class="container mt-5">
            ...
            <div class="voucher-show-info">
                ...
                <div
                    ...
                    <h3 style="margin: 0; font-size: 16px;">
                        <strong>{{ $land_sale_payment->voucher_no }}</strong>
                    </h3>
                </div>
                <div class="mt-1"
        ...
        <div class="voucher-info">
            ...
            <div><strong>Date:
                    {{ date('d/m/Y', strtotime($land_sale_payment->landSale->initial_payment_made_date)) }}</strong>
            </div>
        </div>
        ...
        <div class="details-section">
            <div class="dotted-container"><strong>Head of Accounts:</strong>
                ...
                <span
                    class="dotted-line-voucher">
                    {{
                        $land_sale_payment->landSale->type == 'Flat' ? 'Flat Sale' :
                        ($land_sale_payment->landSale->type == 'Plot' ? 'Plot Sale' :
                        ($land_sale_payment->landSale->type == 'Land' ? 'Land Sale' : ''))
                    }}
            ...
            <div class="dotted-container"><strong>Received From:</strong><span
                    class="dotted-line-voucher">{{ $land_sale_payment->landSale->customer->customer_name ?? '' }}</span>
            </div>
        </div>
    ...
    <div class="container mt-6" style="margin-top: 150px;">
        ...
        <div class="details-section">
            <div class="dotted-container"><strong>Head of Accounts:</strong>
                ...
                <span
                    class="dotted-line-voucher">
                    {{-- {{ $land_sale_payment->landSale->type == 'Flat' ? 'Flat Sale' : 'Plot Sale' }} --}}
                    {{
                        $land_sale_payment->landSale->type == 'Flat' ? 'Flat Sale' :
                        ($land_sale_payment->landSale->type == 'Plot' ? 'Plot Sale' :
                        ($land_sale_payment->landSale->type == 'Land' ? 'Land Sale' : ''))
