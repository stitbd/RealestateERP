    ...
    <div class="money-receipt">
        ...
        <div class="receipt-details" style="display: flex; justify-content: space-between;">
            ...
            <div class="payment-type-section">
                <label>Cash <input type="checkbox" {{ $model->PaymentType->name == 'Cash' ? 'checked' : '' }} /></label>
            ...
            <div style="text-align: left; font-size: 14px; margin-bottom: 10px;">
                ...
                <p style="margin-bottom: 30px;">MR No.: <strong>{{ $model->landSale->invoice_no }}</strong></p>
                <p>Total Amount:
        ...
        <div class="details-section-receipt">
            <p>Received with thanks from
                <span class="dotted-line"><b>{{ $model->landSale->customer->customer_name ?? '' }} &nbsp;(Code -
                        {{ $model->landSale->customer->customer_code ?? '' }})</b></span>
            </p>

            <p>On account of
                <span
                    class="dotted-line"><b>{{ $model->landSale->type == 'Flat' ? 'Flat Sale' : 'Plot Sale' }}</b></span>
            </p>
