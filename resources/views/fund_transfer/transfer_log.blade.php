                           ...
                           @foreach($fund_transfer as $transfer)
                            <tr>
                                ...
                                <td> @if ($transfer->attachment != null)
                                    <a href="{{ asset('attachment/'.$transfer->attachment)}}" target="_blank" class="btn btn-info">
                                        <i class="fa fa-download"></i>
                                    </a>
                                @endif</td>
                                    <td>
                                    <a href="{{route('trasfer-status-update',$transfer->id)}}" onclick="alert('Are You Sure Want to delete this?')" class="btn btn-danger btn-sm"><i class="fa fa-trash pr-2" style=""></i>Delete</a>
                                </td>
                            </tr>
                           @endforeach
                        </tbody>
