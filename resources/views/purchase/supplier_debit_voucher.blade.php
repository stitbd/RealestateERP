...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css" integrity="sha512-DTOQO9RWCH3ppGqcWaEA1BIZOC6xxalwEsw9c2QQeAIftl+Vegovlnee1c9QX4TctnWMn13TZye+giMm8e2LwA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
 ...
 <body>
   <div class="row">
    ...
    <div class="col-sm-2">
        <button class="mt-5 btn btn-info pull-right" onclick="printDiv('printableArea')"><i class="fa-solid fa-print"></i>Print</button>
    </div>
    <div class="col-sm-2">
    ...
    <div class="container mt-5" >
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <label>:</label>
                <span>
                       @if($model->category_id){{$model->category->category_name}} @elseif($model->category_name) {{$category->category_name}}   @endif
                </span>
            </div>
            <div class="col-sm-4">
                <label>Account Head</label>
                <label>:</label>
                <span> @if($model->head_id) {{$model->head->head_name}} @elseif($model->head_name) {{$head->head_name}} @endif</span>
            </div>
            <div class="col-sm-4">
                <label>Code No</label>
                <label>:</label>
        ...
        <div class="row">
            {{-- <div class="col-sm-4">
                ...
                <label>:</label>
                <span>@if($model->designation)  {{$model->designation}} @endif</span>
            </div> --}}
            <div class="col-sm-4">
                <label>Date</label>
                <label>:</label>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <label>:</label>
               <span>@if($model->cheque_number)  {{$model->cheque_number}} @endif</span>
            </div>
            <div class="col-sm-4">
                <label>Cheque Issue Date</label>
                <label>:</label>
                <span>@if($model->cheque_issue_date)  {{$model->cheque_issue_date}} @endif</span>
             </div>
        </div>
        <div class="row mt-3">
            <div class="col-sm-12">
