            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li
                                        class="nav-item {{ request()->is('receipt_and_payment_statement') ? 'menu-open' : '' }}">
                ...
                <li class="nav-item  {{ isset($main_menu) && $main_menu == 'Capital' ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('capital-list') }}"
                                class="nav-link {{ isset($child_menu) && $child_menu == 'capital-list' ? 'active' : '' }}">
                                <i class="far fa-dot-circle nav-icon"></i>
                                <p>Capital</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('transfer-index') }}"
                                class="nav-link {{ isset($child_menu) && $child_menu == 'capital_transfer' ? 'active' : '' }}">
                                <i class="far fa-dot-circle nav-icon"></i>
                ...
                @if (array_search('sales', array_column($menu_permission, 'menu_slug')) !== false)
                    <li class="nav-item {{ isset($main_menu) && $main_menu == 'sales' ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li
                                class="nav-item {{ isset($child_menu) && in_array($child_menu, ['landshare_index', 'landshare_create', 'landshare_edit', 'landshare_show']) ? 'menu-open' : '' }}">
                                <a href="#"
                ...
                <li class="nav-item {{ isset($main_menu) && $main_menu == 'land_purchase' ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li
                            class="nav-item {{ request()->is('save-land-purchase', 'land-purchase') ? 'menu-open' : '' }}">
