 ...
 <body>      
    <div class="container mt-5">
        ...
        <div class="header-section">
            ...
            <div class="voucher-show-info">
                ...
                <div
                    ...
                    <h3 style="margin: 0; font-size: 16px;"><strong>{{ $model->collection->voucher_no }}</strong>
                    </h3>
                </div>
                <div class="mt-1"
        ...
        <div class="voucher-info">
            ...
            <div><input type="checkbox" {{ $model->collection->payment_type == 'Cash' ? 'checked' : '' }}><strong>
                    Cash</strong>
            </div>
            <div><input type="checkbox" {{ $model->collection->payment_type == 'Bank' ? 'checked' : '' }}><strong>
                    Bank</strong>
            </div>
            <div><strong>Date: {{ date('d/m/Y', strtotime($model->collection->date)) }}</strong></div>
        </div>

        <!-- Head of Accounts and Received From Section -->
        <div class="details-section">
            <div class="dotted-container"><strong>Head of Accounts:</strong>
                <span class="dotted-line-voucher">{{ $model->collection->consumer->head->head_name ?? 'No Head Name' }}</span>
            </div>
            <div class="dotted-container"><strong>Received From:</strong><span
                    class="dotted-line-voucher">{{ $model->collection->consumer->consumer_name ?? '' }}</span></div>
        </div>
        ...
        <table class="details-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>{{ number_format($model->collect_amount, 2) }}</td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
                    @php
                        ...
                        $amount = getBangladeshCurrency($model->collect_amount);
                    @endphp
