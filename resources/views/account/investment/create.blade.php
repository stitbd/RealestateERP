                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="date" name="invest_date" required class="form-control">
                                            </div>
                                            <div class="col-lg-6">
                                                <label for="date">Tentative Collection Date<i
                                                        class="text-danger">*</i></label>
                                                <input type="date" name="tentative_collection_date" required
                                                    class="form-control">
                                            </div>

                                            <div class="col-lg-12">
                                                <label for="category">Account Main Head<i class="text-danger">*</i></label>
                                                <select class="form-control chosen-select" name="category" id="category"  onchange="filterHead(this); generateInvestCode();newCategoryAdd();" required>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" class="form-control" name="invest_code"
                                                    id="invest_code" readonly placeholder=" Invest Code No.">
                                            </div>
                                            <div class="col-lg-6">
                                                <label for="invest_amount">Monthly Invest Amount<i class="text-danger">*</i></label>
                                                <input type="number" required name="invest_amount" class="form-control" />
                                            </div>
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6 mb-3">
                                                ...
                                                <input type="date" name="invest_length" class="form-control" required></textarea>
                                            </div>
                                            <div class="col-lg-12 mb-3">
                                                <label for="note">Note (If Any)</label>
                                                <textarea type="text" name="note" cols="2" class="form-control" placeholder="Note..."></textarea>
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" name="consumer_name" required class="form-control">
                                            </div>
                                            <div class="col-lg-6">
