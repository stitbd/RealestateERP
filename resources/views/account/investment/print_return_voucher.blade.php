    ...
    <div class="container mt-5" >
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <label>:</label>
                <span>
                       @if($model->invest->category){{$model->invest->category->category_name}}@endif
                </span>
            </div>
            <div class="col-sm-4">
                <label>Account Sub Head</label>
                <label>:</label>
                <span> @if($model->invest->head) {{$model->invest->head->head_name}}@endif</span>
            </div>
            <div class="col-sm-4">
                <label>Code No</label>
                <label>:</label>
                @php $date = date('Y'); @endphp
                <span>{{$model->return_code}}</span>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
                ...
                <label>:</label>
                <span>{{$model->invest->client_name}}</span>
            </div>
            <div class="col-sm-4">
                <label>Address</label>
                <label>:</label>
                <span>{{$model->invest->address}}</span>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <label>:</label>
                <span>{{$model->invest->fund->name}}</span>
            </div>
            {{-- <div class="col-sm-4">
                    ...
                    <tfoot>
                        <tr>
                            @php
                                ...
                                $amount =  $f->format($model->return_amount);
