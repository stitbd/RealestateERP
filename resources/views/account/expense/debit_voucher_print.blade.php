 ...
 <body>
    ...
    <div class="container mt-5">
        ...
        <div class="voucher-info">
            ...
            <div>
                <input type="checkbox" {{ $model->expense_type == 'adjustment' ? 'checked' : '' }}>
        ...
        <div class="details-section">
            <div class="dotted-container"><strong>Head of Accounts:</strong>
                <span class="dotted-line-voucher">@if ($model->head_id)
                    {{ $model->head->head_name }}
                @endif</span>
            </div>
            <div class="dotted-container"><strong>Paid To:</strong>
                <span class="dotted-line-voucher">@if ($model->expense_by)
                    {{ $model->employee->name }}
                @else
                    {{ $model->expenser_name }}
                @endif</span>
